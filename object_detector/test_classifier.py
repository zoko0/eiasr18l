...
from config import *
from utility_functions import sliding_window, pyramid, rgb2gray
...
if __name__ == '__main__':
    ...
    for image_name in os.listdir(image_dir_path):
        ...
        # detect faces and return  image - before NMS and after TODO: add after MMS
        image_before_nms = detector.detect(image)
